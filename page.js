define(["jquery"], function($) {
    var module = {
        'dependencies':{
            ...
            'page_open':`<div id='page_main_bdjf' style='display:none'>
                    ...
                    <div class="hidden md:block">
                      <div class="ml-4 flex items-center md:ml-6">
                        ...
                        <div class="ml-3 relative">
                          ...
                          -->
                          <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none md:hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
    ...
    module.create = function(component_instance)
    {
        ...
        instance['page_open'] = module.dependencies['page_open'];
        instance['page_inner'] =component_instance;
        instance['page_close'] =  module.dependencies['page_close'];
        ...
        {
            return "page_main_bdjf";
        } 

        instance.render = function()
        {
            return instance['page_open']+instance['page_inner'].render()+instance['page_close'];
        }
        instance.bind = function()
        {
            instance['page_inner'].bind();
        }
        return instance;
    } 
    return module;
